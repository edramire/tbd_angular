        ...
        service.send = function send(imageData) {
            ...
            reader.onload = function onload(event) {
                ...
                var base64Data  = event.target.result.split(',')[1],
                    headerModel = { Authorization: '77859bf72725bd5' },
                ...
                var request = $http({
                    ...
                    method:  'POST',
                    headers: { 'Authorization': 'Client-ID 77859bf72725bd5' },
                    data:    dataModel
                });
