(function(){
    ...
    window.Adoric = window.Adoric || (function () {
        var pagesMap = {
            ...
            MA_Dashboard: {
                url : 'www.wix.com/my-account/sites/'
            },
            MA_DashboardES: {
                url : 'es.wix.com/my-account/sites/'
            },
            MA_DashboardPT: {
                url : 'pt.wix.com/my-account/sites/'
            },
            MA_DashboardRU: {
                url : 'ru.wix.com/my-account/sites/'
            },
            MA_DashboardFR: {
                url : 'fr.wix.com/my-account/sites/'
            },
            MA_DashboardJA: {
                url : 'ja.wix.com/my-account/sites/'
            },
            MA_DashboardTR: {
                url : 'tr.wix.com/my-account/sites/'
            },
            MA_DashboardDE: {
                url : 'de.wix.com/my-account/sites/'
            },
            MA_DashboardIT: {
                url : 'it.wix.com/my-account/sites/'
            },
            MA_DashboardNL: {
                url : 'nl.wix.com/my-account/sites/'
            },
            MA_DashboardKO: {
                url : 'ko.wix.com/my-account/sites/'
            },
            MA_DashboardPL: {
                url : 'pl.wix.com/my-account/sites/'
            },
            MA_DashboardDA: {
                url : 'da.wix.com/my-account/sites/'
            },
            MA_DashboardSV: {
                url : 'sv.wix.com/my-account/sites/'
            },
            MA_DashboardNO: {
                url : 'no.wix.com/my-account/sites/'
            }
        };
        var biMap = {
            close: {
        ...
        function isSiteDashboard() {
            var LAST_INDEX = 36,
                MIN_LENGTH = 37,
                url = window.location.href,
                isSiteDashboard = url.substr(0, LAST_INDEX + 1);

            return isSiteDashboard === 'https://www.wix.com/my-account/sites/' && url.lastIndexOf('/') === LAST_INDEX && url.length > MIN_LENGTH;
        }
        ...
        function isMyAccount() {
            ...
            return isMyAccount === 'https://www.wix.com/my-account/sites/' && url.lastIndexOf('/') === LAST_INDEX;
        }
        ...
        function findPageNameFromUrl() {
            ...
            if (isHomePage()) {
                ...
                var pageName = '';
                var INDEX_OF_PAGE_NAME = 7; // https:// --> STUPID quick hack!!

                _.forOwn(_.keys(pagesMap), function(index) {
                    if((window.location.href).indexOf(pagesMap[index].url) > -1 && (window.location.href).indexOf(pagesMap[index].url) <= INDEX_OF_PAGE_NAME) {
                        if(isSiteDashboard()) {
                            pageName =  'MA_Dashboard';
                        } else {
                            pageName =  index;
                        }
                    }
